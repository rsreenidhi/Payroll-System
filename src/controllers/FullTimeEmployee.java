...
/**
 * <h1>Full Time Employee Controller</h1>
 * This method is used to control the full time employee details
 * @author Ramanuja Sreenidhi
 * @version 1.3
 * @since 2016-11-22
 *
 */
public class FullTimeEmployee extends Employee implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		loginName.setText(Employee.getemployeename() + " - FullTimeEmployee");
	}
